...
export const Todo = {
  encode(message: Todo, writer: Writer = Writer.create()): Writer {
    ...
    if (message.oid !== undefined) {
      ObjectId.encode(toObjectId(message.oid), writer.uint32(18).fork()).ldelim();
    }
    for (const v of message.repeatedOid) {
      ObjectId.encode(toObjectId(v!), writer.uint32(26).fork()).ldelim();
    }
    if (message.optionalOid !== undefined) {
      ObjectId.encode(toObjectId(message.optionalOid), writer.uint32(34).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.oid = fromObjectId(ObjectId.decode(reader, reader.uint32()));
          break;
        case 3:
          message.repeatedOid.push(fromObjectId(ObjectId.decode(reader, reader.uint32())));
          break;
        case 4:
          message.optionalOid = fromObjectId(ObjectId.decode(reader, reader.uint32()));
          break;
        case 5:
...
export const Todo_MapOfOidsEntry = {
  encode(message: Todo_MapOfOidsEntry, writer: Writer = Writer.create()): Writer {
    ...
    if (message.value !== undefined) {
      ObjectId.encode(toObjectId(message.value), writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.value = fromObjectId(ObjectId.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
